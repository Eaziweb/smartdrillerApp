...
const Company = ({ isOpen, onClose }) => {
  ...
  return (
    <div className={styles.aboutModalOverlay} onClick={onClose}>
      <div className={styles.aboutModalContent} onClick={(e) => e.stopPropagation()}>
        <button className={styles.aboutCloseButton} onClick={onClose}>
        ...
        <header className={styles.aboutHeader}>
          <div className={styles.aboutContainer}>
            <nav>
              <Link to="/" className={styles.aboutAppLogo}>SmartDriller</Link>
              <ul className={styles.aboutNavLinks}>
        ...
        <section className={styles.aboutHero} id="about-about">
          <div className={styles.aboutContainer}>
        ...
        <section className={styles.aboutSection} id="about-content">
          <div className={styles.aboutContainer}>
        ...
        <section className={styles.aboutSection} id="about-mission">
          <div className={styles.aboutContainer}>
        ...
        <section className={`${styles.aboutSection} ${styles.aboutBlogSection}`} id="about-blog">
          <div className={styles.aboutContainer}>
            <h2 className={styles.aboutSectionTitle}>From Our Blog</h2>
            <div className={styles.aboutBlogPosts}>
              <div className={styles.aboutBlogCard}>
                <div className={styles.aboutBlogContent}>
                  <h3>Navigating the CCMAS Curriculum</h3>
                  <p className={styles.aboutBlogMeta}>June 15, 2023</p>
                  <p>Practical tips for first-year students adapting to the new CCMAS curriculum structure and expectations...</p>
                  <a href="#" className={styles.aboutReadMore}>Read More <i className="fas fa-arrow-right"></i></a>
                </div>
              </div>
              <div className={styles.aboutBlogCard}>
                <div className={styles.aboutBlogContent}>
                  <h3>Time Management for University Success</h3>
                  <p className={styles.aboutBlogMeta}>May 28, 2023</p>
              ...
              <div className={styles.aboutBlogCard}>
                <div className={styles.aboutBlogContent}>
                  ...
                  <p className={styles.aboutBlogMeta}>April 10, 2023</p>
        ...
        <footer className={styles.aboutFooter}>
          <div className={styles.aboutContainer}>
            <div className={styles.aboutFooterContent}>
              <div className={styles.aboutAppLogo}>SmartDriller</div>
